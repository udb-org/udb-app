import { DataBaseTableConstraintEnum, FieldType, FieldTypeCategory, IDataBase, IDataBaseEX, IDataBaseTable, IDataBaseTableColumn, IDataBaseTableConstraint, IDataBaseTableIndex } from "@/types/db";
...
`;
    ...
    getConstraintByResult(rows: any): IDataBaseTableConstraint[] {
        let constraints: IDataBaseTableConstraint[] = [];
    ...
    getColumnsByResult(rows: any): IDataBaseTableColumn[] {
        // console.log("getColumnsByResult", rows);
        return rows.map((row: any) => {
